...
**Acceptance coverage:** Runtime coverage for `C-13`, `C-14`, and `C-15` from `test/bdd/feat-0710-acceptance.md`; deterministic edge completion is in `acp-chat-interaction-contract.scenario.md`.
