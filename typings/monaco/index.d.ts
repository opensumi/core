...
declare module monaco.keybindings {
    ...
    export class KeybindingResolver {
        static contextMatchesRules(context: monaco.contextkey.IContext, rules: monaco.contextkey.ContextKeyExpr | undefined): boolean;
    }
...
declare module monaco.contextKeyService {
    type ContextKeyService = import("@reexport/vsc-modules/lib/contextkey").ContextKeyService;
    export {
      ContextKeyService,
    };
}
...
declare module monaco.contextkey {
    ...
    type ContextKeyExprType = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyExprType;
    type IContextKeyExprMapper = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContextKeyExprMapper;
    type ContextKeyExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyExpr;
    type ContextKeyDefinedExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyDefinedExpr;
    type ContextKeyEqualsExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyEqualsExpr;
    type ContextKeyNotEqualsExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyNotEqualsExpr;
    type ContextKeyNotExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyNotExpr;
    type ContextKeyRegexExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyRegexExpr;
    type ContextKeyNotRegexExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyNotRegexExpr;
    type ContextKeyAndExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyAndExpr;
    type ContextKeyOrExpr = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").ContextKeyOrExpr;
    type RawContextKey<T> = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").RawContextKey<T>;
    type IContext = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContext;
    type IContextKey<T> = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContextKey<T>;
    type IContextKeyServiceTarget = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContextKeyServiceTarget;
    type IContextKeyService = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContextKeyService;
    type IContextKeyChangeEvent = import("@reexport/vsc-modules/lib/contextkey/common/contextkey").IContextKeyChangeEvent;
