...
import { FileChangeEvent, WatchOptions } from '../file-service-watcher-protocol';
import { FileSystemManage } from '../../node/file-system-manage';
import { DiskFileSystemProvider } from '../../node/disk-file-system.provider';
import { ShadowFileSystemProvider } from '../../node/shadow-file-system.provider';
import { detectEncodingByURI, getEncodingInfo, decode, encode, UTF8 } from '../../node/encoding';
import {
  FileSystemError,
  FileStat,
  IFileService,
...
import { ExtensionFileSystemManage } from '../../node/extension-file-system-manage';
import { FileSystemNodeOptions } from '../../node';

@Injectable()
export class MockFileService extends RPCService implements IFileService {
