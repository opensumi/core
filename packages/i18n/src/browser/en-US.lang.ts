export const localizationBundle = {
  ...
  contents: {
    ...
    'file.comfirm.delete': 'Are you sure you want to delete the following files?\n{0}',
    'file.comfirm.delete.ok': 'Move to trash',
    'file.comfirm.delete.cancel': 'Cancel',
    'file.comfirm.move': 'Are you sure you want to move file {0} to {1}?',
    'file.comfirm.move.ok': 'Move',
    'file.comfirm.move.cancel': 'Cancel',
    'file.comfirm.replace': 'Are you sure you want to replace file {0}?',
    'file.comfirm.replace.ok': 'Replace',
    'file.comfirm.replace.cancel': 'Cancel',
