export const localizationBundle = {
  ...
  contents: {
    ...
    'file.location': '文件定位',
    'file.comfirm.delete': '确定删除下面列的文件?\n{0}',
    'file.comfirm.delete.ok': '移入回收站',
    'file.comfirm.delete.cancel': '取消',
    'file.comfirm.move': '确定移动文件{0} 到 {1}?',
    'file.comfirm.move.ok': '移动',
    'file.comfirm.move.cancel': '取消',
    'file.comfirm.replace': '确定替换{0}文件?',
    'file.comfirm.replace.ok': '替换',
    'file.comfirm.replace.cancel': '取消',
    ...
    'preference.editSettingsJson': '在settings.json中编辑',
