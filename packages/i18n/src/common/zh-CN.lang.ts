...
export const localizationBundle = {
  ...
  contents: {
    ...
    'preference.search.followSymlinks': '控制搜索时是否跟随符号链接。',
    ...
    'aiNative.chat.message.copy': '复制',
    'aiNative.chat.message.copy.success': '已复制',
    'aiNative.chat.expand.unfullscreen': '恢复编辑器和资源管理器',
    'aiNative.chat.expand.fullescreen': '专注 AI 对话',
    ...
    'aiNative.chat.safeProgress.agentWorking': 'Agent 正在工作...',
    'aiNative.chat.safeProgress.agentStopping': 'Agent 正在停止...',
    'aiNative.chat.safeProgress.stillWorking': '仍在工作...',
    ...
    'aiNative.chat.newTask.noAgent': '没有可用的 ACP Agent',
    'aiNative.chat.newTask.workspaceUnavailable': '工作区目标不可用',
    'aiNative.chat.newTask.failed': '新建会话失败',
    'aiNative.chat.newTask.chooseAgent': '选择 Agent',
    'aiNative.chat.newTask.withAgent': '使用 {0} 新建会话',
    'aiNative.chat.agenticTask.draft.title': '新会话',
    'aiNative.chat.agenticTask.draft.context': '使用 {0}',
    'aiNative.chat.agenticTask.draft.prompt': '你希望 Agent 做什么？',
    'aiNative.chat.agenticTask.draft.keepEditing': '继续编辑',
    'aiNative.chat.agenticTask.draft.discard': '放弃草稿',
    'aiNative.chat.agenticTask.draft.discardTitle': '放弃草稿？',
    'aiNative.chat.agenticTask.draft.discardMessage': '未发送的消息将会丢失。',
    'aiNative.chat.session.connectionUnavailable': '无法恢复会话。',
    'aiNative.chat.session.restoringConnection': '正在恢复会话，准备就绪后即可发送消息。',
    ...
    'aiNative.agentic.taskList.archived': '已归档任务',
    'aiNative.agentic.project.fallbackName': '项目',
    'aiNative.agentic.project.add': '添加项目',
    'aiNative.agentic.project.newTask': '在 {0} 中新建会话',
    'aiNative.agentic.project.removeHasSessions': '项目仍有关联的 Agent 会话，无法移除。',
    'aiNative.agentic.sessionList.title': 'Agent 会话',
    'aiNative.agentic.sessionList.resize': '调整 Agent 会话列表宽度',
    'aiNative.agentic.sessionList.refresh': '刷新 Agent 会话',
    'aiNative.agentic.sessionList.search': '搜索会话',
    'aiNative.agentic.sessionList.archived': '已归档会话',
    'aiNative.agentic.session.untitled': '未命名会话',
    'aiNative.agentic.session.loading': '正在加载会话',
    'aiNative.agentic.session.unavailable': '会话不可用',
    'aiNative.agentic.session.archive': '归档会话',
    'aiNative.agentic.session.unarchive': '取消归档会话',
    'aiNative.agentic.session.discardDraftAndSwitch': '放弃草稿并切换',
    'aiNative.agentic.session.switchDiscardDraft':
      '要放弃未发送的草稿并切换会话吗？与该草稿绑定的 Agent 会话将被关闭。',
    ...
    'aiNative.agentic.project.rename.cancel': '取消',
    'aiNative.agentic.project.rename.save': '保存',
    'aiNative.agentic.project.rename.clearHint': '清空名称可恢复使用默认项目名称。',
    'aiNative.agentic.project.name': '项目名称',
    'aiNative.agentic.project.workspace': '工作区：{0}',
    'aiNative.agentic.project.remove': '移除 {0}',
    'aiNative.agentic.project.removeAction': '移除项目',
    'aiNative.agentic.project.removeOnlyManaged': '仅可移除手动添加的项目。',
    'aiNative.agentic.project.removeHasTasks': '项目仍有关联的活动或归档任务，无法移除。',
    'aiNative.agentic.project.collapse': '折叠 {0}',
    'aiNative.agentic.project.expand': '展开 {0}',
    'aiNative.agentic.project.unavailable': '项目不可用。',
    'aiNative.agentic.task.agent': 'Agent：{0}',
    'aiNative.agentic.task.agentLabel': 'Agent',
    'aiNative.agentic.task.status': '状态：{0}',
    'aiNative.agentic.task.statusLabel': '状态',
    'aiNative.agentic.task.status.running': '运行中',
    'aiNative.agentic.task.status.stopping': '正在停止',
    'aiNative.agentic.task.status.stopped': '已停止',
    'aiNative.agentic.task.status.error': '错误',
    'aiNative.agentic.task.status.permissionRequired': '需要授权',
    'aiNative.agentic.task.status.inputNeeded': '需要输入',
    'aiNative.agentic.task.status.agentUnavailable': 'Agent 不可用',
    'aiNative.agentic.task.status.historyUnavailable': '历史会话不可用',
    'aiNative.agentic.task.status.lastKnown': '上次已知状态：{0}',
    'aiNative.agentic.task.status.lastKnownShort': '上次已知 · {0}',
    'aiNative.agentic.task.retryHistory': '选择该任务以重试加载历史会话。',
    'aiNative.agentic.task.unread': '未读',
    'aiNative.agentic.task.unreadSentence': '未读。',
    'aiNative.agentic.task.unreadActivity': '有未读动态',
    'aiNative.agentic.task.archive': '归档 {0}',
    'aiNative.agentic.task.unarchive': '取消归档 {0}',
    'aiNative.command.newChat': 'AI Chat：新建聊天',
    'aiNative.command.newTask': 'Agent：新建会话',
    'aiNative.chat.agenticTask.workingDirectory': 'Agent 工作目录：{0}',
    'aiNative.chat.imageUpload': '上传图片',
    'aiNative.chat.queue.one': '1 个排队任务',
    'aiNative.chat.queue.many': '{0} 个排队任务',
    'aiNative.chat.queue.emptyPreview': '空消息',
    'aiNative.chat.queue.paused': '已暂停',
    'aiNative.chat.queue.pauseReason.manualStop': '已停止',
    'aiNative.chat.queue.pauseReason.agentError': 'Agent 出错',
    'aiNative.chat.queue.pauseReason.startFailed': '启动失败',
    'aiNative.chat.queue.pauseReason.cancelFailed': '停止失败',
    'aiNative.chat.queue.resume': '继续队列',
    'aiNative.chat.queue.clearAll': '全部清除',
    'aiNative.chat.queue.edit': '编辑',
    'aiNative.chat.queue.delete': '删除',
    ...
    'aiNative.chat.queue.clearAriaLabel': '清除排队任务',
    'aiNative.chat.queue.editAriaLabel': '编辑排队任务',
    'aiNative.chat.queue.deleteAriaLabel': '删除排队任务',
    'aiNative.chat.queue.immediateAriaLabel': '立即发送排队任务',
