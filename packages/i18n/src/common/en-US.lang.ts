...
export const localizationBundle = {
  ...
  contents: {
    ...
    'aiNative.chat.agenticTask.draft.context': 'Using {0}. Send your first message to create this Agent session.',
    'aiNative.chat.agenticTask.draft.hint': 'Send your first message to create this Agent session.',
