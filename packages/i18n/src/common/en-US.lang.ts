...
export const localizationBundle = {
  ...
  contents: {
    ...
    'aiNative.chat.newTask.failed': 'Failed to create a new Task',
    'aiNative.chat.newTask.chooseAgent': 'Choose Agent',
    'aiNative.chat.newTask.withAgent': 'New Task with {0}',
    ...
    'aiNative.agentic.project.newTask': 'New Task for {0}',
    ...
    'aiNative.command.newTask': 'Agent: New Task',
