...
export const localizationBundle = {
  ...
  contents: {
    ...
    'aiNative.chat.safeProgress.agentStopping': 'Agent is stopping...',
    ...
    'aiNative.chat.newTask.noAgent': 'No ACP Agent available',
    'aiNative.chat.newTask.workspaceUnavailable': 'Workspace Target unavailable',
    'aiNative.chat.newTask.failed': 'Failed to create a new session',
    'aiNative.chat.newTask.chooseAgent': 'Choose Agent',
    'aiNative.chat.newTask.withAgent': 'New session with {0}',
    'aiNative.chat.agenticTask.draft.title': 'New Session',
    'aiNative.chat.agenticTask.draft.context': 'Using {0}',
    'aiNative.chat.agenticTask.draft.prompt': 'What would you like the Agent to do?',
    'aiNative.chat.agenticTask.draft.keepEditing': 'Keep Editing',
    'aiNative.chat.agenticTask.draft.discard': 'Discard Draft',
    'aiNative.chat.agenticTask.draft.discardTitle': 'Discard draft?',
    'aiNative.chat.agenticTask.draft.discardMessage': 'Your unsent message will be lost.',
    'aiNative.chat.session.connectionUnavailable': 'Unable to restore the session.',
    'aiNative.chat.session.restoringConnection': 'Restoring session. You can send when it is ready.',
    'aiNative.agentic.taskList.title': 'Agent Tasks',
    'aiNative.agentic.taskList.resize': 'Resize Agent Tasks',
    'aiNative.agentic.taskList.search': 'Search tasks',
    'aiNative.agentic.taskList.archived': 'Archived Tasks',
    'aiNative.agentic.project.fallbackName': 'Project',
    'aiNative.agentic.project.add': 'Add Project',
    'aiNative.agentic.project.newTask': 'New session for {0}',
    'aiNative.agentic.project.removeHasSessions': 'Projects with Agent sessions cannot be removed.',
    'aiNative.agentic.sessionList.title': 'Agent Sessions',
    'aiNative.agentic.sessionList.resize': 'Resize Agent Sessions',
    'aiNative.agentic.sessionList.refresh': 'Refresh Agent sessions',
    'aiNative.agentic.sessionList.search': 'Search sessions',
    'aiNative.agentic.sessionList.archived': 'Archived Sessions',
    'aiNative.agentic.session.untitled': 'Untitled session',
    'aiNative.agentic.session.loading': 'Loading session',
    'aiNative.agentic.session.unavailable': 'Session unavailable',
    'aiNative.agentic.session.archive': 'Archive session',
    'aiNative.agentic.session.unarchive': 'Unarchive session',
    'aiNative.agentic.session.discardDraftAndSwitch': 'Discard Draft and Switch',
    ...
    'aiNative.agentic.project.manage': 'Manage {0}',
    'aiNative.agentic.project.rename.action': 'Rename',
    'aiNative.agentic.project.rename.title': 'Rename {0}',
    'aiNative.agentic.project.rename.cancel': 'Cancel',
    'aiNative.agentic.project.rename.save': 'Save',
    'aiNative.agentic.project.rename.clearHint': 'Clear the name to use the default project name.',
    'aiNative.agentic.project.name': 'Project name',
    'aiNative.agentic.project.workspace': 'Workspace: {0}',
    'aiNative.agentic.project.remove': 'Remove {0}',
    'aiNative.agentic.project.removeAction': 'Remove Project',
    'aiNative.agentic.project.removeOnlyManaged': 'Only manually added Projects can be removed.',
    'aiNative.agentic.project.removeHasTasks': 'Projects with active or archived Tasks cannot be removed.',
    'aiNative.agentic.project.collapse': 'Collapse {0}',
    'aiNative.agentic.project.expand': 'Expand {0}',
    'aiNative.agentic.project.unavailable': 'Project unavailable.',
    'aiNative.agentic.task.agent': 'Agent: {0}',
    'aiNative.agentic.task.agentLabel': 'Agent',
    'aiNative.agentic.task.status': 'Status: {0}',
    'aiNative.agentic.task.statusLabel': 'Status',
    'aiNative.agentic.task.status.running': 'Running',
    'aiNative.agentic.task.status.stopping': 'Stopping',
    'aiNative.agentic.task.status.stopped': 'Stopped',
    'aiNative.agentic.task.status.error': 'Error',
    'aiNative.agentic.task.status.permissionRequired': 'Permission required',
    'aiNative.agentic.task.status.inputNeeded': 'Input needed',
    'aiNative.agentic.task.status.agentUnavailable': 'Agent unavailable',
    'aiNative.agentic.task.status.historyUnavailable': 'History unavailable',
    'aiNative.agentic.task.status.lastKnown': 'Last known status: {0}',
    'aiNative.agentic.task.status.lastKnownShort': 'Last known · {0}',
    'aiNative.agentic.task.retryHistory': 'Select the task to retry loading its history.',
    'aiNative.agentic.task.unread': 'Unread',
    'aiNative.agentic.task.unreadSentence': 'Unread.',
    'aiNative.agentic.task.unreadActivity': 'Unread activity',
    'aiNative.agentic.task.archive': 'Archive {0}',
    'aiNative.agentic.task.unarchive': 'Unarchive {0}',
    'aiNative.command.newChat': 'AI Chat: New Chat',
    'aiNative.command.newTask': 'Agent: New Session',
    'aiNative.chat.agenticTask.workingDirectory': 'Agent working directory: {0}',
    'aiNative.chat.imageUpload': 'Upload Image',
    'aiNative.chat.queue.one': '1 Queued Turn',
    'aiNative.chat.queue.many': '{0} Queued Turns',
    'aiNative.chat.queue.emptyPreview': 'Empty message',
    'aiNative.chat.queue.paused': 'Paused',
    'aiNative.chat.queue.pauseReason.manualStop': 'Stopped',
    'aiNative.chat.queue.pauseReason.agentError': 'Agent error',
    'aiNative.chat.queue.pauseReason.startFailed': 'Could not start',
    'aiNative.chat.queue.pauseReason.cancelFailed': 'Could not stop',
    'aiNative.chat.queue.resume': 'Resume Queue',
    'aiNative.chat.queue.clearAll': 'Clear All',
    'aiNative.chat.queue.edit': 'Edit',
    'aiNative.chat.queue.delete': 'Delete',
    ...
    'aiNative.chat.queue.clearAriaLabel': 'Clear queued turns',
    'aiNative.chat.queue.editAriaLabel': 'Edit queued turn',
    'aiNative.chat.queue.deleteAriaLabel': 'Delete queued turn',
    'aiNative.chat.queue.immediateAriaLabel': 'Send queued turn immediately',
