export const browserViews = {
  ...
  "kaitianContributes.common.command": "要执行的命令。该命令必须在 \"contributes.command\" 中声明（内置命令除外）",
  "kaitianContributes.common.when": "此条件必须为 true 才能显示此项",
  "kaitianContributes.common.group": "此项所属的组",
...
inline 模式 showTitle 会失效, 只显示 icon`,
  ...
  // menu
  "kaitianContributes.menu": "提供菜单项",
  "kaitianContributes.menu.api.CommandPalette": "命令面板菜单",
  "kaitianContributes.menu.api.ActivityBarExtra": "左侧活动栏底部的菜单",
  "kaitianContributes.menu.api.DebugBreakpointsContext": "调试断点的右键菜单",
  "kaitianContributes.menu.api.DebugCallStackContext": "调试调用堆栈的右键菜单",
  "kaitianContributes.menu.api.DebugConsoleContext": "底部调试控制台日志面板的右键菜单",
  "kaitianContributes.menu.api.DebugVariablesContext": "调试变量面板的右键菜单",
  "kaitianContributes.menu.api.DebugWatchContext": "调试监视面板的右键菜单",
  "kaitianContributes.menu.api.DebugToolBar": "调试工具栏的菜单",
  "kaitianContributes.menu.api.EditorContext": "编辑器内的右键菜单",
  "kaitianContributes.menu.api.EditorTitle": "编辑器右上角的标题菜单",
  "kaitianContributes.menu.api.EditorTitleContext": "编辑器上方的选项卡右键菜单",
  "kaitianContributes.menu.api.ExplorerContext": "资源管理器的右键菜单",
  "kaitianContributes.menu.api.MenubarAppMenu": "顶层主菜单的子菜单（仅限本地 Electron 端）",
  "kaitianContributes.menu.api.MenubarEditMenu": "顶层 \"编辑\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarFileMenu": "顶层 \"文件\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarGoMenu": "顶层 \"前往\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarHelpMenu": "顶层 \"帮助\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarViewMenu": "顶层 \"视图\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarSelectionMenu": "顶层 \"选择\" 菜单中的子菜单",
  "kaitianContributes.menu.api.MenubarTerminalMenu": "顶层 \"终端\" 菜单中的子菜单",
  "kaitianContributes.menu.api.TerminalInstanceContext": "终端面板的右键菜单",
  "kaitianContributes.menu.api.TerminalNewDropdownContext": "终端选项卡右边的下拉框子菜单",
  "kaitianContributes.menu.api.TerminalTabContext": "终端选项卡的右键菜单",
  "kaitianContributes.menu.api.OpenEditorsContext": "资源管理器里 \"打开的编辑器\" 的右键菜单",
  "kaitianContributes.menu.api.SCMResourceContext": "SCM 源代码管理状态的右键菜单",
  "kaitianContributes.menu.api.SCMResourceGroupContext": "SCM 源代码管理资源组的右键菜单",
  "kaitianContributes.menu.api.SCMResourceFolderContext": "SCM 源代码管理资源文件夹的右键菜单",
  "kaitianContributes.menu.api.SCMTitle": "SCM 源代码管理的顶部菜单项",
  "kaitianContributes.menu.api.SCMInput": "SCM 源代码管理的输入框右侧菜单",
  "kaitianContributes.menu.api.SearchContext": "跨文件搜索结果的右键菜单",
  "kaitianContributes.menu.api.StatusBarContext": "最底部状态栏的右键菜单",
  "kaitianContributes.menu.api.ViewItemContext": "提供的自定义视图的右键菜单",
  "kaitianContributes.menu.api.ViewTitle": "提供的自定义视图的顶部菜单项",
  "kaitianContributes.menu.api.SettingsIconMenu": "左下角 \“偏好设置\" 的右键菜单",

  // submenu
  "kaitianContributes.submenus": "提供子菜单项（属性的 key 是已经在 \"contributes.menubars\" 注册好的 menubar id）",
  "kaitianContributes.submenus.id": "是已经在 \"contributes.menus\" 注册好的 menu id",
  "kaitianContributes.submenus.title": "子菜单项的名称",
  "kaitianContributes.submenus.icon": `(可选) 用于表示 UI 中的子菜单的图标。文件路径、具有深色和浅色主题的文件路径的对象，或者主题图标引用(如 "$(zap)")`,
  "kaitianContributes.submenus.icon.light": `使用浅色主题时的图标路径`,
  "kaitianContributes.submenus.icon.dark": `使用深色主题时的图标路径`,
}
