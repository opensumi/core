export default {
  ...
  colors: {
    ...
    'editorGroupHeader.tabsBackground': '#dbe4ee',
    ...
    'kt.primaryButton.background': '#fff',
    'kt.primaryButton.clickBackground': '#fff',
    'kt.primaryButton.foreground': '#151B21',
    'kt.primaryButton.hoverBackground': '#fff',
    ...
    'menu.separatorBackground': '#151b2114',
