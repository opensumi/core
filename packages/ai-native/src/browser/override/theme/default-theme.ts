export default {
  ...
  colors: {
    ...
    'kt.primaryButton.background': '#ffffff14',
    'kt.primaryButton.clickBackground': '#ffffff14',
    'kt.primaryButton.foreground': '#fffffff2',
    'kt.primaryButton.hoverBackground': '#ffffff29',
