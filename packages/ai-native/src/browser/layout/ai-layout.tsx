...
const AGENTIC_HORIZONTAL_RESIZE_HANDLE_SIZE = 8;
const AGENTIC_WORKBENCH_RESPONSIVE_BREAKPOINT =
  AGENTIC_WORKBENCH_MIN_RESIZE * 2 + AGENTIC_HORIZONTAL_RESIZE_HANDLE_SIZE;
