...
const InnerCommandGroups = {
  ...
  'Data Science and Notebooks': [
    ...
    'python.datascience.runCurrentCellAndAdvance',
    'python.datascience.runCurrentCellandAllBelow',
    'python.datascience.debugCurrentCell',
    ...
    'python.datascience.selectjupytercommandline',
    ...
    'python.datascience.switchKernel',
