...
import { URI, Emitter, MaybeNull, IdleValue, compareRangesUsingStarts, getSymbolIcon, Event, StorageProvider, STORAGE_NAMESPACE, IStorage } from '@ali/ide-core-browser';
