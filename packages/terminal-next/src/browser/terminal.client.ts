...
import { Disposable, Deferred, Emitter, Event, debounce, ILogger, IDisposable, URI, IApplicationService, IReporter, REPORT_NAME } from '@ide-framework/ide-core-common';
import { OperatingSystem, OS } from '@ide-framework/ide-core-common/lib/platform';
...
import { IVariableResolverService } from '@ide-framework/ide-variable/lib/common';
...
import { CorePreferences, QuickPickService } from '@ide-framework/ide-core-browser';
