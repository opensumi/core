...
import { isOSX, URI, CommandService, localize } from '@ali/ide-core-common';
...
import { InputValidationType } from '../../lib';
...
function convertValidationType(type: InputValidationType) {
