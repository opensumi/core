...
export function DesignModeLayout() {
  const { layout } = getStorageValue();
  return (
    <BoxPanel direction='top-to-bottom'>
      <SlotRenderer id='design-layout-top' defaultSize={35} slot='top' z-index={2} />
      <SplitPanel id='main-horizontal' flex={1}>
        <SlotRenderer
          slot='left'
          isTabbar={true}
      ...
      <SlotRenderer id='design-layout-statusbar' defaultSize={24} slot='statusBar' />
    </BoxPanel>
  );
}
