...
import { ExtensionDocumentDataManager, IExtHostLanguages } from '@ali/ide-kaitian-extension/lib/common/vscode';
...
@Injectable()
export class LiteDocumentDataManager implements Partial<ExtensionDocumentDataManager> {
