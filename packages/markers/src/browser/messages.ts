...
export default class Messages {
  ...
  public static markerPanelFilterInputPlaceholder = () => localize('markers.filter.placefolder', '筛选器，例如：text、**/*.ts、!**/node_modules/**');
  ...
  public static markerPanelFilterContentEmpty = () => localize('markers.filter.content.empty', '在给定的筛选条件下，没有找到结果。');
