import { MarkerSeverity } from '@ali/ide-core-browser';
import { Color, DARK, LIGHT, ThemeType, HIGH_CONTRAST } from '@ali/ide-theme';
...
export { DARK, LIGHT, HIGH_CONTRAST, ThemeType } from '@ali/ide-theme';
