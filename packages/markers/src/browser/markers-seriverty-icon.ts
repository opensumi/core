import { MarkerSeverity } from '@ide-framework/ide-core-browser';
import { Color, DARK, LIGHT, ThemeType, HIGH_CONTRAST } from '@ide-framework/ide-theme';
...
function getSVGData(severity: MarkerSeverity, theme: ThemeType): string {
  switch (severity) {
    case MarkerSeverity.Hint:
      ...
      return theme === LIGHT ? infoStart + encodeURIComponent(ignoreColor.toString()) + infoEnd
    ...
    case MarkerSeverity.Info:
      ...
      return theme === LIGHT ? infoStart + encodeURIComponent(infoColor.toString()) + infoEnd
    ...
    case MarkerSeverity.Warning:
      ...
      return theme === LIGHT ? warningStart + encodeURIComponent(warningColor.toString()) + warningEnd
    ...
    case MarkerSeverity.Error:
      ...
      return theme === LIGHT ? errorStart + encodeURIComponent(errorColor.toString()) + errorEnd
...
export { DARK, LIGHT, HIGH_CONTRAST, ThemeType } from '@ide-framework/ide-theme';
