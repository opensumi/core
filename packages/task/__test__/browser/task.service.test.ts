...
import { ITaskService, ITaskSystem, ITaskProvider } from '@ide-framework/ide-task/lib/common';
...
import { FileUri, Uri } from '@ide-framework/ide-core-common';
import { MonacoService } from '../../../monaco';
import { PreferenceService, IJSONSchemaRegistry, ISchemaStore, QuickOpenService } from '@ide-framework/ide-core-browser';
import { SchemaRegistry, SchemaStore } from '../../../monaco/src/browser/schema-registry';
import { taskSchemaUri, schema } from '@ide-framework/ide-task/lib/browser/task.schema';
...
import { MockQuickOpenService } from '@ide-framework/ide-quick-open/lib/common/mocks/quick-open.service';
