import { BrowserModule, Domain, ClientAppContribution, ContributionProvider, PreferenceService, createPreferenceProxy } from '@ide-framework/ide-core-browser';
...
import { Injectable, Provider, Autowired, Injector, INJECTOR_TOKEN } from '@ide-framework/common-di';
...
import { ICommandServiceToken, IMonacoActionRegistry, IMonacoCommandsRegistry } from '@ide-framework/ide-monaco/lib/browser/contrib/command';
