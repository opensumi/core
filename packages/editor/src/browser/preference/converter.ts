...
interface IMonacoOptionsConverter {
   ...
   */
export const editorOptionsConverters: Map<KaitianPreferenceKey , NoConverter | IMonacoOptionsConverter> = new Map<string , NoConverter | IMonacoOptionsConverter>([
    /**
...
export const diffEditorOptionsConverters: Map<KaitianPreferenceKey , NoConverter | IMonacoOptionsConverter> = new Map<string , NoConverter | IMonacoOptionsConverter>([
  /**
