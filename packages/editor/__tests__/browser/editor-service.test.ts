...
import { EditorCollectionService, WorkbenchEditorService, ResourceService, ILanguageService, EditorGroupSplitAction} from '@ide-framework/ide-editor/lib/common';
...
import { EditorComponentRegistry, IEditorDecorationCollectionService, IEditorDocumentModelContentRegistry, IEditorDocumentModelService, EmptyDocCacheImpl, IEditorFeatureRegistry, BrowserEditorContribution, EditorGroupChangeEvent, CodeEditorDidVisibleEvent } from '@ide-framework/ide-editor/lib/browser';
import { IDocPersistentCacheProvider } from '@ide-framework/ide-editor/lib/common';
...
import { EditorDocumentModelContentRegistryImpl, EditorDocumentModelServiceImpl, SaveTask } from '@ide-framework/ide-editor/lib/browser/doc-model/main';
...
import { URI, Disposable, createContributionProvider, ILoggerManagerClient, IEventBus } from '@ide-framework/ide-core-common';
...
import { CorePreferences, IContextKeyService, PreferenceService } from '@ide-framework/ide-core-browser';
...
import { isEditStack, isEOLStack } from '@ide-framework/ide-editor/lib/browser/doc-model/editor-is-fn';
