...
import { EditorCollectionService, WorkbenchEditorService, ResourceService, ILanguageService, EditorGroupSplitAction} from '@opensumi/ide-editor/lib/common';
...
import { EditorComponentRegistry, IEditorDecorationCollectionService, IEditorDocumentModelContentRegistry, IEditorDocumentModelService, EmptyDocCacheImpl, IEditorFeatureRegistry, BrowserEditorContribution, EditorGroupChangeEvent, CodeEditorDidVisibleEvent } from '@opensumi/ide-editor/lib/browser';
...
import { EditorDocumentModelContentRegistryImpl, EditorDocumentModelServiceImpl, SaveTask } from '@opensumi/ide-editor/lib/browser/doc-model/main';
...
import { URI, Disposable, createContributionProvider, ILoggerManagerClient, IEventBus } from '@opensumi/ide-core-common';
