...
import { WorkbenchEditorService, ILanguageService, CursorStatus } from '@ali/ide-editor';
import { EditorStatusBarService } from '@ali/ide-editor/lib/browser/editor.status-bar.service';
