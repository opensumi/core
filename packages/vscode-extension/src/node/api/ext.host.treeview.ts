// import { IExtHostTreeView, IMainThreadTreeView, IExtHostCommands, MainThreadAPIIdentifier } from '../../common';
// import { IRPCProtocol } from '@ali/ide-connection';
// import { TreeView, TreeViewItem, TreeViewSelection } from '../../common/ext-types';
// import { IDisposable, Emitter, Disposable } from '@ali/ide-core-browser';
...
//   registerTreeDataProvider<T>(plugin: Plugin, treeViewId: string, treeDataProvider: vscode.TreeDataProvider<T>): IDisposable {
...
//   createTreeView<T>(plugin: Plugin, treeViewId: string, options: { treeDataProvider: vscode.TreeDataProvider<T> }): TreeView<T> {
//     if (!options || !options.treeDataProvider) {
//       throw new Error('Options with treeDataProvider is mandatory');
//     }

//     const treeView = new ExtHostTreeView(plugin, treeViewId, options.treeDataProvider, this.proxy);
