...
const onTSServerClientCreated = new vscode.EventEmitter();
function extensionWillActivate(ctx) {
    ctx.registerPublicApi({
        onTSServerClientCreated: onTSServerClientCreated.event
    });
}
exports.extensionWillActivate = extensionWillActivate;
