...
export class RenameAdapter {
    ...
    provideRenameEdits(resource: URI, position: model.Position, newName: string, token: vscode.CancellationToken): Promise<model.WorkspaceEditDto | undefined> {
    ...
    resolveRenameLocation(resource: URI, position: model.Position, token: vscode.CancellationToken): Promise<model.RenameLocation & model.Rejection | undefined> {
