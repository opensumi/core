...
import { getDebugLogger, Event, CancellationToken, asPromise, CancellationTokenSource, Emitter, DisposableStore, Uri, IDisposable } from '@ide-framework/ide-core-common';
...
namespace TaskDTO {
  ...
  export async function to(value: TaskDTO | undefined, extHostWorkspace: IExtHostWorkspace, providedCustomExecutions: Map<string, types.CustomExecution>): Promise<types.Task | undefined> {
    if (value === undefined || value === null) {
      return undefined;
    }
