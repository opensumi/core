...
import { Uri as vscodeUri, Emitter, IFileServiceClient, URI, Uri, IEventBus, PreferenceScope, ILoggerManagerClient, FileUri, CommonServerPath, OS, IApplicationService, DisposableCollection } from '@ide-framework/ide-core-common';
...
import { ExtHostAPIIdentifier, MainThreadAPIIdentifier } from '@ide-framework/ide-kaitian-extension/lib/common/vscode';
import { ExtHostMessage } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.message';
import { ExtensionDocumentDataManagerImpl } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/doc';
import { ExtHostPreference } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.preference';
import { ExtHostFileSystem } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.file-system';
import { IWorkspaceService } from '@ide-framework/ide-workspace';
import { IDocPersistentCacheProvider, ResourceService } from '@ide-framework/ide-editor/lib/common';
import { FileServiceClient, BrowserFileSystemRegistryImpl } from '@ide-framework/ide-file-service/lib/browser/file-service-client';
import { FileServicePath, FileStat, FileType, IBrowserFileSystemRegistry, IDiskFileProvider } from '@ide-framework/ide-file-service';
import { FileService, FileSystemNodeOptions } from '@ide-framework/ide-file-service/lib/node';
import { ExtensionStorageModule } from '@ide-framework/ide-extension-storage/lib/browser';
import { ExtensionService } from '@ide-framework/ide-kaitian-extension';
import { ExtensionServiceImpl } from '@ide-framework/ide-kaitian-extension/lib/browser/extension.service';
...
import MonacoServiceImpl from '@ide-framework/ide-monaco/lib/browser/monaco.service';
...
import { StaticResourceServiceImpl } from '@ide-framework/ide-static-resource/lib/browser/static.service';
import { AppConfig } from '@ide-framework/ide-core-node';
import { MainThreadExtensionDocumentData } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.doc';
import { IEditorDocumentModelContentRegistry, IEditorDocumentModelService, EmptyDocCacheImpl, EditorDocumentModelCreationEvent, EditorComponentRegistry, EditorPreferences } from '@ide-framework/ide-editor/lib/browser';
import { EditorDocumentModelContentRegistryImpl, EditorDocumentModelServiceImpl } from '@ide-framework/ide-editor/lib/browser/doc-model/main';
import { FileSchemeDocumentProvider } from '@ide-framework/ide-file-scheme/lib/browser/file-doc';
import { MainThreadPreference } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.preference';
import { PreferenceProviderProvider, PreferenceProvider, PreferenceService, PreferenceServiceImpl } from '@ide-framework/ide-core-browser';
import { injectMockPreferences } from '@ide-framework/ide-core-browser/__mocks__/preference';
import { ResourceServiceImpl } from '@ide-framework/ide-editor/lib/browser/resource.service';
import { EditorComponentRegistryImpl } from '@ide-framework/ide-editor/lib/browser/component';
import { ExtHostStorage } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.storage';
import { ExtHostTasks } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/tasks/ext.host.tasks';
...
import { MainThreadFileSystem } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.file-system';
import { ExtHostFileSystemEvent } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.file-system-event';
...
import { Position, WorkspaceEdit } from '@ide-framework/ide-kaitian-extension/lib/common/vscode/ext-types';
import { IWorkspaceEditService, IWorkspaceFileService } from '@ide-framework/ide-workspace-edit';
import { WorkspaceEditServiceImpl } from '@ide-framework/ide-workspace-edit/lib/browser/workspace-edit.service';
import { WorkspaceFileService } from '@ide-framework/ide-workspace-edit/lib/browser/workspace-file.service';
