...
import { Emitter, IFileServiceClient, IEventBus, CommonServerPath, OS, IApplicationService } from '@ide-framework/ide-core-common';
import { URI, IContextKeyService } from '@ide-framework/ide-core-browser';
...
import { WorkbenchEditorService, EditorCollectionService, ResourceService, ILanguageService, IDocPersistentCacheProvider } from '@ide-framework/ide-editor/lib/common';
import { WorkbenchEditorServiceImpl, EditorGroup } from '@ide-framework/ide-editor/lib/browser/workbench-editor.service';
import { IEditorDecorationCollectionService, IEditorDocumentModelContentRegistry, IEditorDocumentModelService, IEditorFeatureRegistry, EditorModule, EmptyDocCacheImpl, EditorPreferences } from '@ide-framework/ide-editor/lib/browser';
import { EditorDecorationCollectionService } from '@ide-framework/ide-editor/lib/browser/editor.decoration.service';
import { EditorCollectionServiceImpl } from '@ide-framework/ide-editor/lib/browser/editor-collection.service';
...
import { EditorGroupChangeEvent, EditorVisibleChangeEvent, EditorGroupIndexChangedEvent, EditorSelectionChangeEvent } from '@ide-framework/ide-editor/lib/browser/types';
...
import { CorePreferences, MonacoOverrideServiceRegistry } from '@ide-framework/ide-core-browser';
import { ResourceServiceImpl } from '@ide-framework/ide-editor/lib/browser/resource.service';
import { LanguageService } from '@ide-framework/ide-editor/lib/browser/language/language.service';
...
import { EditorComponentRegistry } from '@ide-framework/ide-editor/lib/browser/types';
import { MockContextKeyService } from '../../../monaco/__mocks__/monaco.context-key.service';
import { IResource, IEditorOpenType } from '@ide-framework/ide-editor';
import { IConfigurationService, IConfigurationChangeEvent, ConfigurationTarget } from '@ide-framework/monaco-editor-core/esm/vs/platform/configuration/common/configuration';
import * as TypeConverts from '@ide-framework/ide-kaitian-extension/lib/common/vscode/converter';
import { MonacoOverrideServiceRegistryImpl } from '@ide-framework/ide-monaco/lib/browser/override.service.registry';
