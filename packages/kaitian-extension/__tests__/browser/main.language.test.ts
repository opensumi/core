...
import { createModel } from '@ide-framework/monaco-editor-core/esm/vs/editor/standalone/browser/standaloneEditor';
...
import { URI, Uri, Position } from '@ide-framework/ide-core-common';
...
import { Emitter, CancellationToken, MonacoService, DisposableCollection } from '@ide-framework/ide-core-browser';
...
import { ICallHierarchyService } from '@ide-framework/ide-monaco/lib/browser/contrib';
import { CallHierarchyService } from '@ide-framework/ide-editor/lib/browser/monaco-contrib';
import { IEditorDocumentModelService, IEditorDocumentModelContentRegistry, EmptyDocCacheImpl } from '@ide-framework/ide-editor/src/browser';
...
import { TestEditorDocumentProvider } from '@ide-framework/ide-editor/__tests__/browser/test-providers';
