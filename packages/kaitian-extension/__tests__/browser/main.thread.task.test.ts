...
import { ExtHostTasks, createTaskApiFactory } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/tasks/ext.host.tasks';
import { MainthreadTasks } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.tasks';
...
import { Task, ShellExecution } from '@ide-framework/ide-kaitian-extension/lib/common/vscode/ext-types';
...
import { MainThreadWorkspace } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.workspace';
