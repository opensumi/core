...
import { ExtHostStatusBar } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.statusbar';
import { MainThreadStatusBar } from '@ide-framework/ide-kaitian-extension/lib/browser/vscode/api/main.thread.statusbar';
import { StatusBarAlignment } from '@ide-framework/ide-kaitian-extension/lib/common/vscode/ext-types';
