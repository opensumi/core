import { KTExtension } from '@ide-framework/ide-kaitian-extension/lib/hosted/vscode.extension';
...
describe('kaitian-extension/__tests__/hosted/vscode.extension.test.ts', () => {
  ...
  it('the extension will not be activated repeatedly', async () => {
    ...
    const extension = new KTExtension(metadata, extensionService, mainThreadExtensionService, exportsData, extendExportsData);
