...
import { Emitter as EventEmitter, Disposable, ILoggerManagerClient, StorageProvider, Uri, IFileServiceClient } from '@ide-framework/ide-core-common';
import { RPCProtocol } from '@ide-framework/ide-connection';
import { ITerminalApiService, ITerminalClientFactory, ITerminalController, ITerminalGroupViewService, ITerminalInternalService, ITerminalService, ITerminalTheme } from '@ide-framework/ide-terminal-next';
...
import { ExtHostWorkspace } from '@ide-framework/ide-kaitian-extension/lib/hosted/api/vscode/ext.host.workspace';
...
import { IWorkspaceService } from '@ide-framework/ide-workspace/lib/common/workspace-defination';
...
import { IMainLayoutService } from '@ide-framework/ide-main-layout/lib/common/main-layout.defination';
...
import { ITaskDefinitionRegistry, TaskDefinitionRegistryImpl } from '@ide-framework/ide-core-common/lib/task-definition';
import { IVariableResolverService } from '@ide-framework/ide-variable';
import { VariableResolverService } from '@ide-framework/ide-variable/lib/browser/variable-resolver.service';
import { TerminalGroupViewService } from '@ide-framework/ide-terminal-next/lib/browser/terminal.view';
import { TerminalClientFactory } from '@ide-framework/ide-terminal-next/lib/browser/terminal.client';
...
import { TerminalPreference } from '@ide-framework/ide-terminal-next/lib/browser/terminal.preference';
import { ITerminalPreference } from '@ide-framework/ide-terminal-next/lib/common/preference';
