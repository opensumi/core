...
describe('ExtensionScanner', () => {
  describe('ExtensionScanner.getExtensionIdByExtensionPath', () => {
    it('can read publisher.name', () => {
      const extensionPath = '/User/hacke2/.kaitian/extensions/cloud-ide.debug-1.0.0';
    ...
    it('can read publisher.name and give version', () => {
      const extensionPath = '/User/hacke2/.kaitian/extensions/cloud-ide.debug-lite-1.0.0';
    ...
    it('can read extensionId', () => {
      const extensionPath = '/User/hacke2/.kaitian/extensions/5da45c36392bdd7063eb0e11-configuration-editing-1.0.0';
      const extensionId = ExtensionScanner.getExtensionIdByExtensionPath(extensionPath);
