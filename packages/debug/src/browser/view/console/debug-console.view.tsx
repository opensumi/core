...
import { useInjectable, ViewState, getIcon } from '@ide-framework/ide-core-browser';
import { DebugConsoleService } from './debug-console.service';
import { RecycleTree, IRecycleTreeHandle, TreeNodeType, INodeRendererWrapProps, ClasslistComposite, INodeRendererProps, CompositeTreeNode, TreeNode, TreeNodeEvent } from '@ide-framework/ide-components';
...
import { PreferenceService, PreferenceChange, CoreConfiguration } from '@ide-framework/ide-core-browser';
