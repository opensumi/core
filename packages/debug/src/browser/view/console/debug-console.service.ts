...
import { MonacoCodeService } from '@ide-framework/ide-editor/lib/browser/editor.override';
import * as monaco from '@ide-framework/monaco-editor-core/esm/vs/editor/editor.api';
import { IHistoryNavigationWidget } from '@ide-framework/monaco-editor-core/esm/vs/base/browser/history';
import { HistoryNavigator } from '@ide-framework/monaco-editor-core/esm/vs/base/common/history';
...
import { Schemas, URI, CommandRegistry, Emitter, Event, STORAGE_NAMESPACE } from '@ide-framework/ide-core-common';
import { IEditorDocumentModelService, IEditorDocumentModelContentProvider, ICodeEditor, getSimpleEditorOptions } from '@ide-framework/ide-editor/lib/browser';
import { EditorCollectionService, IDecorationApplyOptions } from '@ide-framework/ide-editor';
import { IContextKeyService, MonacoOverrideServiceRegistry, ServiceNames, localize, StorageProvider } from '@ide-framework/ide-core-browser';
...
import { transparent, editorForeground, IThemeService } from '@ide-framework/ide-theme';
