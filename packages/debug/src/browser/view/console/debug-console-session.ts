...
export class DebugConsoleSession implements IDebugConsoleSession {
  ...
  private async insertItemWithAnsi(
    ...
    this.treeModel.root.insertItem(
      new AnsiConsoleNode(output, this.treeModel?.root, this.linkDetector, ansiNode, severity, source, line, this.aiNativeConfig.capabilities.supportsDebug, this.commandService),
    );
  }
