...
import * as strings from '@ide-framework/ide-core-common/lib/utils/strings';
import { IEditorFeatureContribution } from '@ide-framework/ide-editor/lib/browser';
import { IEditor, IDecorationApplyOptions } from '@ide-framework/ide-editor';
import { IDisposable, Disposable, RunOnceScheduler, CancellationTokenSource, onUnexpectedExternalError, Position, createMemoizer, Emitter, Event } from '@ide-framework/ide-core-common';
import { flatten } from '@ide-framework/ide-core-common/lib/arrays';
import { Injectable, Autowired } from '@ide-framework/common-di';
import { IContextKeyService, PreferenceService, MonacoOverrideServiceRegistry, ServiceNames } from '@ide-framework/ide-core-browser';
...
import { StandardTokenType } from '@ide-framework/monaco-editor-core/esm/vs/editor/common/modes';
import { ITextModel } from '@ide-framework/monaco-editor-core/esm/vs/editor/common/model';
import { Constants } from '@ide-framework/ide-core-common/lib/uint';
