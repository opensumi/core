...
import { Disposable, IFileServiceClient } from '@ide-framework/ide-core-common';
import { DebugHoverSource } from '@ide-framework/ide-debug/lib/browser/editor/debug-hover-source';
import { IDebugSessionManager, IDebugSession, DebugSessionOptions, DebugModelFactory, IDebugServer } from '@ide-framework/ide-debug';
...
import { DebugConsoleModelService, IDebugConsoleModel } from '@ide-framework/ide-debug/lib/browser/view/console/debug-console-tree.model.service';
import { IContextKeyService } from '@ide-framework/ide-core-browser';
import { DebugSessionFactory, DefaultDebugSessionFactory, DebugPreferences, DebugSessionContributionRegistry } from '@ide-framework/ide-debug/lib/browser';
