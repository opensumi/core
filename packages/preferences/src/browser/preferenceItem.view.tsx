...
const SettingStatus = ({
  ...
  return (
    <span className={styles.preference_status}>
      ...
      {showReset ? (
        <span
          className={clxx(styles.preference_reset, getIcon('rollback'))}
          onClick={() => {
...
function InputPreferenceItem({
  ...
  return (
    <>
      <div className={clxx(styles.key, styles.item)}>
        {localizedName}{' '}
        <SettingStatus
        ...
        <li className={styles.array_items} key={`${idx}-${stringified}`}>
          ...
          <div className={styles.operate}>
            <Button
              ...
              className={clxx(getIcon('edit'), styles.array_item)}
            ></Button>
            <Button
              type='icon'
              ...
              className={clxx(getIcon('delete'), styles.array_item)}
            ></Button>
          </div>
        </li>
      );
