...
const MenuAction: React.FC<{
  ...
  <div className={clx(styles.menuAction, { [styles.disabled]: disabled, [styles.checked]: data.checked })}>
...
> = React.memo(({ iconService, type = 'icon', data, context = [], className, afterClick, ...restProps }) => {
  ...
  if (type === 'icon' && !data.type) {
    return (
      <Button
        ...
        className={clx(styles.iconAction, className, {
  ...
  if (data.type === 'checkbox') {
    return (
      <CheckBox
        className={clx(className, styles.btnAction)}
...
> = React.memo(
  ({
    ...
    return (
      <div className={clx([styles.titleActions, className])} data-menu-id={menuId}>
        ...
        {primary.map((item) => {
          ...
          return (
            <InlineActionWidget
              id={id}
              key={id}
              className={clx({ [styles.selected]: item.checked })}
              type={type}
              data={item}
