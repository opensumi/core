...
export const inputPlaceholderForeground = registerColor('input.placeholderForeground', { light: '#5F656B', dark: '#5F656B', hc: secondaryForegroundColor }, localize('inputPlaceholderForeground', 'Input box foreground color for placeholder text.'));
...
export const inputValidationErrorBackground = registerColor('inputValidation.errorBackground', { dark: '#5A1D1D', light: '#5A1D1D', hc: Color.black }, localize('inputValidationErrorBackground', 'Input validation background color for error severity.'));
export const inputValidationErrorForeground = registerColor('inputValidation.errorForeground', { dark: '#D7DBDE', light: '#D7DBDE', hc: null }, localize('inputValidationErrorForeground', 'Input validation foreground color for error severity.'));
