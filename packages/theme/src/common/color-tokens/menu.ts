...
export const menuForeground = registerColor('menu.foreground', { dark: dropdownForeground, light: foreground, hc: dropdownForeground }, localize('menuForeground', 'Foreground color of menu items.'));
export const menuBackground = registerColor('menu.background', { dark: dropdownBackground, light: dropdownBackground, hc: dropdownBackground }, localize('menuBackground', 'Background color of menu items.'));
...
export const menuSeparatorBackground = registerColor('menu.separatorBackground', { dark: '#BBBBBB6B', light: '#8888886B', hc: contrastBorder }, localize('menuSeparatorBackground', 'Color of a separator menu item in menus.'));
