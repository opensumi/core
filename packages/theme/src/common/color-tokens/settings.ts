...
// Enum control colors
export const settingsSelectBackground = registerColor('settings.dropdownBackground', { dark: dropdownBackground, light: dropdownBackground, hc: dropdownBackground }, localize('settingsDropdownBackground', '(For settings editor preview) Settings editor dropdown background.'));
export const settingsSelectForeground = registerColor('settings.dropdownForeground', { dark: dropdownForeground, light: dropdownForeground, hc: dropdownForeground }, localize('settingsDropdownForeground', '(For settings editor preview) Settings editor dropdown foreground.'));
export const settingsSelectBorder = registerColor('settings.dropdownBorder', { dark: dropdownBorder, light: dropdownBorder, hc: dropdownBorder }, localize('settingsDropdownBorder', '(For settings editor preview) Settings editor dropdown border.'));
...
// Bool control colors
export const settingsCheckboxBackground = registerColor('settings.checkboxBackground', { dark: dropdownBackground, light: dropdownBackground, hc: dropdownBackground }, localize('settingsCheckboxBackground', '(For settings editor preview) Settings editor checkbox background.'));
export const settingsCheckboxForeground = registerColor('settings.checkboxForeground', { dark: dropdownForeground, light: dropdownForeground, hc: dropdownForeground }, localize('settingsCheckboxForeground', '(For settings editor preview) Settings editor checkbox foreground.'));
export const settingsCheckboxBorder = registerColor('settings.checkboxBorder', { dark: dropdownBorder, light: dropdownBorder, hc: dropdownBorder }, localize('settingsCheckboxBorder', '(For settings editor preview) Settings editor checkbox border.'));
