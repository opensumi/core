...
export const ktPopoverProminentBackground = registerColor('kt.popover.prominentBackground', { dark: '#2C3033', light: '#F2F2F2', hc: NOTIFICATIONS_BACKGROUND }, localize('Popover prominent background color.'));
