...
export const ktSelectDropdownBackground = registerColor('kt.selectDropdown.background', { dark: '#35393D', light: inputBackground, hc: null }, localize('ktSelectDropdownBackground', 'Select Dropdown Background color.'));
