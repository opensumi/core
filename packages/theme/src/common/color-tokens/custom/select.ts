...
export const ktSelectBorder = registerColor('kt.select.border', { dark: settingsSelectBorder, light: settingsSelectBorder, hc: dropdownBorder }, localize('ktSelectBorder', 'Select Border color.'));
export const ktSelectPlaceholderForeground = registerColor('kt.select.placeholderForeground', { dark: '#5F656B', light: '#5F656B', hc: null }, localize('ktSelectPlaceholder', 'Select Placeholder Foreground color.'));
...
export const ktSelectOptionActiveBackground = registerColor('selectOption.activeBackground', { dark: '#00000040', light: '#FFFFFF40', hc: null }, localize('ktSelectOptionActiveBackground', 'Select Option Active Background color.'));
...
export const ktSelectDropdownBackground = registerColor('kt.selectDropdown.background', { dark: dropdownBackground, light: dropdownBackground, hc: dropdownBackground }, localize('ktSelectDropdownBackground', 'Select Dropdown Background color.'));
