...
import { FileUri, URI, Disposable, StorageProvider, IApplicationService, isWindows, isLinux, OS } from '@ide-framework/ide-core-common';
...
import { FileStat, FileServicePath, IDiskFileProvider, IFileServiceClient } from '@ide-framework/ide-file-service';
...
import { TreeNodeEvent, TreeNodeType } from '@ide-framework/ide-components';
...
import { IContextKeyService, CorePreferences, EDITOR_COMMANDS, PreferenceService } from '@ide-framework/ide-core-browser';
