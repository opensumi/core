...
import { ExtHostIDEWindow, ExtIDEWebviewWindow } from '@ide-framework/ide-extension/lib/hosted/api/sumi/ext.host.window';
import { createBrowserInjector } from '../../../../../../tools/dev-tool/src/injector-helper';
import { createWindowApiFactory } from '@ide-framework/ide-extension/lib/hosted/api/sumi/ext.host.window';
import { IWindowInfo } from '@ide-framework/ide-extension/lib/common/sumi/window';
