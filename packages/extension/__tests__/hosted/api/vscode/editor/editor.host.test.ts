import { TextEditorData } from '@ide-framework/ide-extension/lib/hosted/api/vscode/editor/editor.host';
import { SnippetString, Position, Range } from '@ide-framework/ide-extension/lib/common/vscode/ext-types';
...
describe(__filename, () => {
  describe('TextEditorData', () => {
    ...
    it('insert snippet when no location', () => {
      ...
      expect($insertSnippet).toBeCalledWith(expect.anything(), snippetString.value, [{'endColumn': 1, 'endLineNumber': 1, 'startColumn': 1, 'startLineNumber': 1}], undefined);
    });
    ...
    it('insert snippet with positions', () => {
      ...
      expect($insertSnippet).toBeCalledWith(expect.anything(), snippetString.value, [{'endColumn': 1, 'endLineNumber': 1, 'startColumn': 1, 'startLineNumber': 1}, {'endColumn': 1, 'endLineNumber': 2, 'startColumn': 1, 'startLineNumber': 2}], undefined);
    });
