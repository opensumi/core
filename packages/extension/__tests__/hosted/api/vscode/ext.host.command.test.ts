...
import { ExtHostCommands, createCommandsApiFactory } from '@ide-framework/ide-extension/lib/hosted/api/vscode/ext.host.command';
import { IRPCProtocol } from '@ide-framework/ide-connection';
import { MainThreadAPIIdentifier, IMainThreadCommands, CommandHandler } from '@ide-framework/ide-extension/lib/common/vscode';
import { mockService } from '../../../../../../tools/dev-tool/src/mock-injector';
import { IExtensionInfo, Uri } from '@ide-framework/ide-core-common';
import * as modes from '@ide-framework/ide-extension/lib/common/vscode/model.api';
import * as types from '@ide-framework/ide-extension/lib/common/vscode/ext-types';
import { SymbolKind } from '@ide-framework/ide-extension/lib/common/vscode/ext-types';
