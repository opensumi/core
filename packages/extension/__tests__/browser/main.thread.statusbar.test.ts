...
import { ExtHostStatusBar } from '@ide-framework/ide-extension/lib/hosted/api/vscode/ext.host.statusbar';
import { MainThreadStatusBar } from '@ide-framework/ide-extension/lib/browser/vscode/api/main.thread.statusbar';
import { StatusBarAlignment } from '@ide-framework/ide-extension/lib/common/vscode/ext-types';
