...
import { Uri as vscodeUri, Emitter, IFileServiceClient, URI, Uri, IEventBus, PreferenceScope, ILoggerManagerClient, FileUri, CommonServerPath, OS, IApplicationService, DisposableCollection } from '@opensumi/ide-core-common';
...
import { FileServiceClient, BrowserFileSystemRegistryImpl } from '@opensumi/ide-file-service/lib/browser/file-service-client';
import { FileServicePath, FileStat, FileType, IBrowserFileSystemRegistry, IDiskFileProvider } from '@opensumi/ide-file-service';
...
import { IEditorDocumentModelContentRegistry, IEditorDocumentModelService, EmptyDocCacheImpl, EditorDocumentModelCreationEvent, EditorComponentRegistry, EditorPreferences } from '@opensumi/ide-editor/lib/browser';
import { EditorDocumentModelContentRegistryImpl, EditorDocumentModelServiceImpl } from '@opensumi/ide-editor/lib/browser/doc-model/main';
...
import { PreferenceProviderProvider, PreferenceProvider, PreferenceService, PreferenceServiceImpl } from '@opensumi/ide-core-browser';
