...
import { ExtHostPreference } from '@ide-framework/ide-extension/lib/hosted/api/vscode/ext.host.preference';
import { ExtHostFileSystem } from '@ide-framework/ide-extension/lib/hosted/api/vscode/ext.host.file-system';
...
import { MainThreadExtensionDocumentData } from '@ide-framework/ide-extension/lib/browser/vscode/api/main.thread.doc';
...
import { MainThreadPreference } from '@ide-framework/ide-extension/lib/browser/vscode/api/main.thread.preference';
...
import { ExtHostTasks } from '@ide-framework/ide-extension/lib/hosted/api/vscode/tasks/ext.host.tasks';
...
import { MainThreadFileSystem } from '@ide-framework/ide-extension/lib/browser/vscode/api/main.thread.file-system';
import { ExtHostFileSystemEvent } from '@ide-framework/ide-extension/lib/hosted/api/vscode/ext.host.file-system-event';
...
import { Position, WorkspaceEdit } from '@ide-framework/ide-extension/lib/common/vscode/ext-types';
