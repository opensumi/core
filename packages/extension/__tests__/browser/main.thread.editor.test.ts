...
import { Emitter, IFileServiceClient, IEventBus, CommonServerPath, OS, IApplicationService } from '@opensumi/ide-core-common';
...
import { WorkbenchEditorService, EditorCollectionService, ResourceService, ILanguageService, IDocPersistentCacheProvider } from '@opensumi/ide-editor/lib/common';
import { WorkbenchEditorServiceImpl, EditorGroup } from '@opensumi/ide-editor/lib/browser/workbench-editor.service';
import { IEditorDecorationCollectionService, IEditorDocumentModelContentRegistry, IEditorDocumentModelService, IEditorFeatureRegistry, EditorModule, EmptyDocCacheImpl, EditorPreferences } from '@opensumi/ide-editor/lib/browser';
...
import { IConfigurationService, IConfigurationChangeEvent, ConfigurationTarget } from '@opensumi/monaco-editor-core/esm/vs/platform/configuration/common/configuration';
