...
import { ExtensionService } from '@ide-framework/ide-extension/lib/common';
...
import * as TypeConverts from '@ide-framework/ide-extension/lib/common/vscode/converter';
