...
import { AbstractExtInstanceManagementService, IActivationEventService } from '@ide-framework/ide-extension/lib/browser/types';
...
import { BrowserRequireInterceptorContribution } from '@ide-framework/ide-extension/lib/browser/require-interceptor.contribution';
