...
export interface IMainThreadComments {
  ...
  $createCommentThread(handle: number, commentThreadHandle: number, threadId: string, resource: UriComponents, range: IRange, extensionId: string): modes.CommentThread | undefined;
