...
export class MockedMonacoUri implements UriComponents, monaco.Uri {
  ...
  static isUri(thing: any): thing is MockedMonacoUri {
    ...
    return typeof ( thing as MockedMonacoUri).authority === 'string'
  ...
  with(change: { scheme?: string; authority?: string | null; path?: string | null; query?: string | null; fragment?: string | null }): MockedMonacoUri {
   ...
   */
  static parse(value: string, _strict: boolean = false): MockedMonacoUri {
  ...
  static from(components: { scheme: string; authority?: string; path?: string; query?: string; fragment?: string }): MockedMonacoUri {
    return new _URI(
      components.scheme,
