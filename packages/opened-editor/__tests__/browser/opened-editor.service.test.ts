...
import { WorkbenchEditorService, ResourceDecorationChangeEvent, IResource } from '@ide-framework/ide-editor';
import { MockWorkbenchEditorService } from '@ide-framework/ide-editor/lib/common/mocks/workbench-editor.service';
...
import { URI, IEventBus, Emitter } from '@ide-framework/ide-core-common';
import { IThemeService } from '@ide-framework/ide-theme';
import { MockThemeService } from '@ide-framework/ide-theme/lib/common/mocks/theme.service';
import { EDITOR_COMMANDS } from '@ide-framework/ide-core-browser';
import { IMainLayoutService } from '@ide-framework/ide-main-layout';
import { IEditorDocumentModelService, ResourceService } from '@ide-framework/ide-editor/lib/browser';
import { OpenedEditorModelService } from '@ide-framework/ide-opened-editor/lib/browser/services/opened-editor-model.service';
import { OpenedEditorService } from '@ide-framework/ide-opened-editor/lib/browser/services/opened-editor-tree.service';
import { TreeNodeType } from '@ide-framework/ide-components';
import { EditorFile, OpenedEditorData } from '@ide-framework/ide-opened-editor/lib/browser/opened-editor-node.define';
