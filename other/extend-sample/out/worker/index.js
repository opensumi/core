var kaitian_extend_browser_worker_shangpo_zw_language_test =
...
function activate(context) {
    var componentProxy = context.componentProxy, registerExtendModuleService = context.registerExtendModuleService;
    console.log('activate ui simple node', 'kaitian');
    console.log(kaitian);
    var count = 0;
    registerExtendModuleService({
        bizWorkerHello: function () {
...
module.exports = kaitian.shangpo_zw_language_test;
