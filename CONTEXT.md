...
**Chat Draft**: A transient ACP Chat composition state that is not yet backed by an ACP session. In Classic Layout, New Chat enters a Chat Draft and the first Prompt creates its ACP session. _Avoid_: New Session, empty session
