  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        '**/packages/extension/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/file-tree-next/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/scm/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/editor/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/editor/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/theme/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        '**/packages/main-layout/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
        ...
        '**/packages/outline/__test?(s)__/browser/**/?(*.)+(spec|test).[jt]s?(x)',
