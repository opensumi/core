...
class LanguageProvider extends dispose_1.Disposable {
    ...
    async registerProviders() {
        ...
        const cachedResponse = new baseCodeLensProvider_1.CachedResponse();
        ...
        this._register((await Promise.resolve().then(() => require('./features/jsDocCompletions'))).register(selector, this.client));
