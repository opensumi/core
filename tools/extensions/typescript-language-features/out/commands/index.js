...
const updateCompilerOptions_1 = require("./updateCompilerOptions");
function registerCommands(commandManager, lazyClientHost, pluginManager) {
    ...
    commandManager.register(new updateCompilerOptions_1.UpdateCompilerOptionsCommand(lazyClientHost));
}
