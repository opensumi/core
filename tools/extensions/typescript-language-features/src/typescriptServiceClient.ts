...
export default class TypeScriptServiceClient extends Disposable implements ITypeScriptServiceClient {
	...
	public setCompilerOptionsForInferredProjects(configuration: TypeScriptServiceConfiguration, extraCompilerOptions: any = {}): void {
		...
		const args: Proto.SetCompilerOptionsForInferredProjectsArgs = {
			options: {
				...this.getCompilerOptionsForInferredProjects(configuration),
