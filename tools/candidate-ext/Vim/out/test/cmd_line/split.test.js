...
suite('Horizontal split', () => {
    ...
    test('Run :sp', () => __awaiter(this, void 0, void 0, function* () {
        yield commandLine_1.commandLine.Run('sp', modeHandler.vimState);
    ...
    test('Run :split', () => __awaiter(this, void 0, void 0, function* () {
        yield commandLine_1.commandLine.Run('split', modeHandler.vimState);
        yield testUtils_1.WaitForEditorsToClose(2);
        testUtils_1.assertEqual(vscode.window.visibleTextEditors.length, 2, 'Editor did not split in 1 sec');
    }));
    test('Run :new', () => __awaiter(this, void 0, void 0, function* () {
        yield commandLine_1.commandLine.Run('split', modeHandler.vimState);
        yield testUtils_1.WaitForEditorsToClose(2);
        testUtils_1.assertEqual(vscode.window.visibleTextEditors.length, 2, 'Editor did not split in 1 sec');
    }));
