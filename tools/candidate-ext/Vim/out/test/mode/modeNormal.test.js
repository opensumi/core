...
suite('Mode Normal', () => {
    ...
    test('Can be activated', () => __awaiter(this, void 0, void 0, function* () {
        ...
        for (let key of activationKeys) {
            ...
            testUtils_1.assertEqual(modeHandler.currentMode.name, mode_1.ModeName.Normal, `${key} doesn't work.`);
        }
    ...
    suite('can handle gn', () => {
        test(`gn selects the next match text`, () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield modeHandler.handleMultipleKeyEvents('gg'.split(''));
        ...
        const gnSelectsCurrentWord = (jumpCmd) => __awaiter(this, void 0, void 0, function* () {
            yield modeHandler.handleMultipleKeyEvents('ifoo\nhello world\nhello\nhello'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['<Esc>', ...'/hello\n'.split('')]);
            yield modeHandler.handleMultipleKeyEvents(jumpCmd.split(''));
            yield modeHandler.handleMultipleKeyEvents(['g', 'n']);
            testUtils_1.assertEqual(modeHandler.currentMode.name, mode_1.ModeName.Visual);
            const selection = textEditor_1.TextEditor.getSelection();
            testUtils_1.assertEqual(selection.start.character, 0);
        ...
        test(`gn selects the current word at |hello`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('2gg');
        }));
        test(`gn selects the current word at h|ello`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('2ggl');
        }));
        test(`gn selects the current word at hel|lo`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('2ggeh');
        }));
        test(`gn selects the current word at hell|o`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('2gge');
        }));
        test(`gn selects the next word at hello|`, () => __awaiter(this, void 0, void 0, function* () {
            yield modeHandler.handleMultipleKeyEvents('ifoo\nhello world\nhello\nhello'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['<Esc>', ...'/hello\n'.split('')]);
            yield modeHandler.handleMultipleKeyEvents('2ggel'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['g', 'n']);
            testUtils_1.assertEqual(modeHandler.currentMode.name, mode_1.ModeName.Visual);
            const selection = textEditor_1.TextEditor.getSelection();
            testUtils_1.assertEqual(selection.start.character, 0);
            testUtils_1.assertEqual(selection.start.line, 2);
            testUtils_1.assertEqual(selection.end.character, 'hello'.length);
    ...
    suite('can handle gN', () => {
        test(`gN selects the previous match text`, () => __awaiter(this, void 0, void 0, function* () {
            yield modeHandler.handleMultipleKeyEvents('ihello world\nhello\nhi hello\nfoo'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['<Esc>', ...'/hello\n'.split('')]);
            yield modeHandler.handleMultipleKeyEvents(['G']);
            yield modeHandler.handleMultipleKeyEvents(['g', 'N']);
            testUtils_1.assertEqual(modeHandler.currentMode.name, mode_1.ModeName.Visual);
            const selection = textEditor_1.TextEditor.getSelection();
            testUtils_1.assertEqual(selection.start.character, 'hi '.length);
            testUtils_1.assertEqual(selection.start.line, 2);
            testUtils_1.assertEqual(selection.end.character, 'hi hello'.length);
            testUtils_1.assertEqual(selection.end.line, 2);
        }));
        const gnSelectsCurrentWord = (jumpCmd) => __awaiter(this, void 0, void 0, function* () {
            yield modeHandler.handleMultipleKeyEvents('ihello world\nhello\nhi hello\nfoo'.split(''));
        ...
        test(`gN selects the current word at hell|o`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('3gg7l');
        }));
        test(`gN selects the current word at hel|lo`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('3gg6l');
        }));
        test(`gN selects the current word at h|ello`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('3gg4l');
        }));
        test(`gN selects the current word at |hello`, () => __awaiter(this, void 0, void 0, function* () {
            yield gnSelectsCurrentWord('3gg3l');
        }));
        test(`gN selects the previous word at | hello`, () => __awaiter(this, void 0, void 0, function* () {
            yield modeHandler.handleMultipleKeyEvents('ihello world\nhello\nhi hello\nfoo'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['<Esc>', ...'/hello\n'.split('')]);
            yield modeHandler.handleMultipleKeyEvents('3gg2l'.split(''));
            yield modeHandler.handleMultipleKeyEvents(['g', 'N']);
            testUtils_1.assertEqual(modeHandler.currentMode.name, mode_1.ModeName.Visual);
            const selection = textEditor_1.TextEditor.getSelection();
            testUtils_1.assertEqual(selection.start.character, 0);
...
//# sourceMappingURL=modeNormal.test.js.map
